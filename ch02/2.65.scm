		...
		(else
		 (let ((x1 (car set1))
		   ...
		   (cond ((= x1 x2)
				 ...
				 ((< x1 x2)
				  (cons x1 (union-ordered-list (cdr set1) set2)))
				 ((> x1 x2)
				  (cons x2 (union-ordered-list set1 (cdr set2)))))))))

; 2.65
(define (union-set set1 set2)
  (let ((list1 (tree->list-2 set1))
		(list2 (tree->list-2 set2)))
	(let ((union (union-ordered-list list1 list2)))
		(list->tree union))))

(define (intersection-set set1 set2)
  (let ((list1 (tree->list-2 set1))
		(list2 (tree->list-2 set2)))
	(let ((intersection (intersection-ordered-list list1 list2)))
